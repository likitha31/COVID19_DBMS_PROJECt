...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    ...
    <li class="nav-item">
      <a href="#addpat" class="nav-link text-dark font-italic">
...
<div class="page-content p-5" id="content">
	<div class="card" >
		  ...
		  <div class="card-body">
		    <h5 id="addpat" class="card-title">Add Patients</h5>
		    <form action="../forms/patient.jsp" method="post" class="form-inline">
			  <div class="form-group align-items-center">
			  	<div class="col-auto">
			  		<button type="submit" class="btn btn-primary mb-2">AddNew</button>
			  	</div>
			  </div>
			</form>
			...
			<h5 id="upd" class="card-title">Update Patient Status</h5>
