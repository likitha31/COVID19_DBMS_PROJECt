...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    ...
    <li class="nav-item">
      <a href="#add_hosp" class="nav-link text-dark font-italic">
                <i class="fa fa-line-chart mr-3 text-primary fa-fw"></i>
                Add a Hospital
       </a>
    </li>
...
<div class="page-content p-5" id="content">
	...
	<div class="card" id="add_hosp">
		  <img src="../Images/hosp.jpg" class="card-img-top" alt="...">
		  <div class="card-body">
		    <h5 class="card-title">Add A Hospital</h5>
		    <a href="../forms/hospital.jsp" class="btn btn-primary">ADD</a>
		  </div>
	</div>
